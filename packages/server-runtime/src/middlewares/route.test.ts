import type { RouteTargetExpression, WebSocketBaseEvent, WebSocketEventOf, WebSocketEvents } from '@jiaban/server-shared/types'
...
describe('route middleware', () => {
  ...
  it('policy middleware filters targets', () => {
    const peers = new Map<string, AuthenticatedPeer>([
      ...
      ['peer-2', createPeer({ id: 'peer-2', name: 'desktop-ui', plugin: 'desktop-ui', instanceId: 'desktop-ui-1', labels: { env: 'dev' } })],
    ])
