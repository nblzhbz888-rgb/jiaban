...
export interface ModuleIdentity {
   ...
   * Example: "telegram-01", "desktop-ui-2f7c9".
   */
  id: string
  /**
 ...
 * Example:
 *  {
 *    configId: "desktop-session-panel",
 *    revision: 12,
 *    schemaVersion: 2,
...
export enum WebSocketEventSource {
  Server = 'jiaban:server-runtime',
  StageWeb = 'jiaban:stage-web',
  Desktop = 'jiaban:desktop',
}
...
export type WebSocketEventInputText = WebSocketEventInputTextBase & Partial<WithInputSource<'stage-web' | 'desktop' | 'discord'>>
...
export type WebSocketEventInputTextVoice = WebSocketEventInputTextVoiceBase & Partial<WithInputSource<'stage-web' | 'desktop' | 'discord'>>
...
export type WebSocketEventInputVoice = WebSocketEventInputVoiceBase & Partial<WithInputSource<'stage-web' | 'desktop' | 'discord'>>
...
} & Partial<WithInputSource<'stage-web' | 'desktop' | 'discord'>> & Partial<WithOutputSource<'gen-ai:chat'>>
