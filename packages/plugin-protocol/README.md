# @jiaban/plugin-protocol

Shared protocol contracts for plugin-module communication in Jiaban.
...
```ts
import type { WebSocketEvent, WebSocketEventOf, WebSocketEvents } from '@jiaban/plugin-protocol/types'

import { moduleAnnounce, moduleAuthenticate } from '@jiaban/plugin-protocol/types'
```
