import type { ResizeDirection } from '@jiaban/electron-eventa'
...
import { createServerChannelService } from '../../services/runtime/channel-server'
import { createI18nService } from '../../services/runtime/i18n'
